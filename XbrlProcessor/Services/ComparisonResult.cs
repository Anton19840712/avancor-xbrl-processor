...
public record ComparisonResult
{
    ...
    /// </summary>
    public required IReadOnlyList<Fact> MissingFacts { get; init; }

    /// <summary>
    /// Новые факты, присутствующие только во втором отчете
    /// </summary>
    public required IReadOnlyList<Fact> NewFacts { get; init; }

    /// <summary>
    /// Факты с различающимися значениями
    /// </summary>
    public required IReadOnlyList<FactDifference> ModifiedFacts { get; init; }
}
